...
class VelocityFieldNetwork(nn.Module):
    ...
    def forward(
        ...
        consistency = float(self.temporal(velocity).squeeze().detach())
...
class TemporalPairConsistency(nn.Module):
    ...
    def compute_consistency_loss(
        ...
        return weighted_loss, {
            "v1_consistency": c1,
            "v2_consistency": c2,
            "velocity_mse": float(consistency_loss.detach()),
...
class FlowMatchingConsistencySystem:
    ...
    def generate_with_temporal_consistency(
        ...
        """Alias for :meth:`generate_with_temporal` (pre-rename API)."""
        return self.generate_with_temporal(
            initial_state,
...
if __name__ == "__main__":
    ...
    result = system.generate_with_temporal(
        initial_state,
