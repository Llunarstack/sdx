...
def main():
    ...
    parser.add_argument("--layout-type", type=str, default="balanced", 
                       choices=["grid", "circle", "line", "pyramid", "balanced"])
    parser.add_argument("--spatial-constraints", type=str, default="",
                       help="Comma-separated spatial constraints")
    
    # Text rendering parameters
    parser.add_argument("--text-content", type=str, default="",
                       help="Comma-separated text content to render")
    parser.add_argument("--typography-style", type=str, default="modern",
                       choices=["modern", "classic", "display", "script"])
    
    # Consistency parameters
    parser.add_argument("--character-name", type=str, default="",
                       help="Character name for consistency")
    parser.add_argument("--style-name", type=str, default="",
                       help="Style name for consistency")
