...
class DatasetAnalyzer:
    ...
    def check_data_quality(self) -> Dict[str, Any]:
        ...
        return {"issues": issues, "warnings": warnings, "image_stats": image_stats, "caption_stats": caption_stats}
    ...
    def generate_report(self, save_path: Optional[str] = None) -> str:
        ...
        if cap_stats:
            ...
            report.append(
                f"  Has Emphasis: {cap_stats['has_emphasis']:,} ({cap_stats['has_emphasis'] / cap_stats['total_captions'] * 100:.1f}%)"
            )
            report.append(
                f"  Has Quality Tags: {cap_stats['has_quality_tags']:,} ({cap_stats['has_quality_tags'] / cap_stats['total_captions'] * 100:.1f}%)"
            )
...
def analyze_caption_emphasis(caption: str) -> Dict[str, Any]:
    ...
    results = {"has_emphasis": False, "emphasis_count": 0, "emphasis_types": [], "emphasized_terms": []}
