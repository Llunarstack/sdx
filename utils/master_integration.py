...
from .config_validator import estimate_memory_usage, suggest_optimizations, validate_train_config
from .consistency_system import create_consistency_system
from .data_analysis import DatasetAnalyzer
from .error_handling import get_model_info, setup_logging, validate_checkpoint
...
class SDXMaster:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        stats = {"system_info": log_system_info(), "generation_stats": {}, "training_stats": {}, "model_info": {}}
    ...
    def validate_setup(self) -> Dict[str, Any]:
        ...
        validation["ready_for_training"] = (
            validation["config_loaded"] and validation["model_loaded"] and validation["diffusion_loaded"]
        )

        validation["ready_for_inference"] = validation["model_loaded"] and validation["multimodal_ready"]
