...
class AnatomyValidator:
    ...
    def generate_anatomy_aware_prompt(self, base_prompt: str, 
        ...
        anatomy_enhancers = {
            "hands": [
                "perfect hands", "correct fingers", "five fingers", "natural hand pose",
                "detailed hands", "anatomically correct hands", "well-formed fingers"
            ],
            "face": [
                "symmetrical face", "natural expression", "correct proportions",
                "detailed facial features", "realistic face", "proper eye placement"
            ],
            "posture": [
                "natural posture", "correct anatomy", "realistic proportions",
                "proper body mechanics", "anatomically accurate", "believable pose"
            ],
            "arms": [
                "natural arm position", "correct arm length", "proper elbow bend",
                "realistic arm pose", "anatomically correct arms"
            ],
            "legs": [
                "natural leg position", "correct proportions", "proper knee bend",
                "realistic stance", "anatomically correct legs"
            ]
        }
    ...
    def create_pose_reference_prompt(self, pose_type: str, 
                                   person_description: str = "person") -> str:
...
class HandCorrector:
    ...
    def generate_hand_focused_prompt(self, base_prompt: str, 
                                   hand_pose: str = "relaxed",
                                   emphasis_level: str = "high") -> str:
...
class MultiPersonComposer:
    ...
    def _extract_people_count(self, description: str) -> int:
        ...
        count_indicators = {
            "two people": 2, "couple": 2, "pair": 2, "duo": 2,
            "three people": 3, "trio": 3, "group of three": 3,
            "four people": 4, "group of four": 4, "quartet": 4,
            "group": 3, "crowd": 5  # Default assumptions
        }
