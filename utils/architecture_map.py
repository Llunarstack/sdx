...
THEMES: Tuple[ThemeMapping, ...] = (
    ThemeMapping(
        ...
        ("--prediction-type v", "--timestep-sample-mode"),
    ),
    ThemeMapping(
        "diffusion_bridges",
    ...
    ThemeMapping(
        ...
        ("scripts/tools/orchestrate_pipeline.py", "utils/orchestration.py"),
        ("--num", "--pick-best"),
    ),
    ThemeMapping(
        "resolution_buckets",
    ...
    ThemeMapping(
        ...
        ("sample.py", "utils/test_time_pick.py", "scripts/tools/orchestrate_pipeline.py"),
        ("--num", "--pick-best"),
    ),
    ThemeMapping(
        "live_grounding_web",
