...
| **`tr/`** | `hf_export_to_sdx_manifest.py`, `hf_download_and_train.py`, `precompute_latents.py`, … |
| **`tools/`** | Day-to-day utilities — flat legacy scripts + grouped entrypoints (`tools/dev`, `tools/data`, `tools/prompt`, `tools/ops`, `tools/export`, `tools/repo`) — see **[tools/README.md](tools/README.md)** |
