...
_CANONICAL: dict[str, Path] = {
    ...
    "extract_civitai_snippets_for_content_controls": _HERE / "extract_civitai_snippets_for_content_controls.py",
    "curate_civitai_triggers": _HERE / "curate_civitai_triggers.py",
    "fetch_civitai_nsfw_concepts": _HERE / "fetch_civitai_nsfw_concepts.py",
