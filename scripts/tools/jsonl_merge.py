...
:func:`utils.native_tools.merge_jsonl_files` (pure Python).

Usage (repo root)::

    python scripts/tools/jsonl_merge.py -o merged.jsonl a.jsonl b.jsonl
    python scripts/tools/jsonl_merge.py -o merged.jsonl --dedupe-key path part1.jsonl part2.jsonl
"""
...
def main() -> int:
    ...
    from utils.native_tools import merge_jsonl_files
