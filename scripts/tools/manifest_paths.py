...
Examples::
    ...
    python scripts/tools/manifest_paths.py data/train.jsonl
    python scripts/tools/manifest_paths.py data/train.jsonl --sort > paths.txt
    python scripts/tools/manifest_paths.py data/train.jsonl --dup
    # Pipe path list to Zig pathstat (if built):
    #   python scripts/tools/manifest_paths.py m.jsonl | native/zig/sdx-pathstat/zig-out/bin/sdx-pathstat
"""
...
from utils.native_tools import (  # noqa: E402
