"""
Tests for ``diffusion/sampling`` (advanced sampling helpers).
...
class TestHolyGrailBlueprint:
    def test_step_plan_at_start(self):
        from diffusion.sampling.blueprint import HolyGrailRecipe, build_holy_grail_step_plan
...
class TestHolyGrailPresets:
    def test_list_presets(self):
        from diffusion.sampling.presets import list_holy_grail_presets
    ...
    def test_get_preset(self):
        from diffusion.sampling.presets import get_holy_grail_preset
    ...
    def test_preset_values_sane(self):
        from diffusion.sampling.presets import HOLY_GRAIL_PRESETS
...
class TestRuntimeGuard:
    def test_sanitize_clamps_cfg_ratios(self):
        from diffusion.sampling.runtime_guard import sanitize_holy_grail_kwargs
...
class TestConditionAnnealing:
    def test_cads_noise_std_at_start(self):
        from diffusion.sampling.condition_annealing import cads_noise_std
    ...
    def test_apply_condition_noise_shape(self):
        from diffusion.sampling.condition_annealing import apply_condition_noise
...
class TestLatentRefiner:
    def test_unsharp_mask_shape(self):
        from diffusion.sampling.latent_refiner import unsharp_mask_latent
    ...
    def test_dynamic_percentile_clamp_shape(self):
        from diffusion.sampling.latent_refiner import dynamic_percentile_clamp
    ...
    def test_consistency_blend_shape(self):
        from diffusion.sampling.latent_refiner import consistency_blend_latent
...
class TestRecommender:
    def test_anime_prompt(self):
        from diffusion.sampling.recommender import recommend_holy_grail_preset
