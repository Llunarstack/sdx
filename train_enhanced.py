...
class ProgressBar:
    ...
    def update(self, step, loss, lr, extra_info=None):
        ...
        info_str = f"{self.description}: {progress:.1f}% | Step {step}/{self.total_steps} | Loss: {loss:.4f} | LR: {lr:.2e}"
...
def get_enhanced_config():
    ...
    parser.add_argument("--model", type=str, default="EnhancedDiT-XL/2", 
