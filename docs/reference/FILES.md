...
| [utils/architecture/architecture_map.py](../../utils/architecture/architecture_map.py) | **2026 architecture themes** → SDX parity (`THEMES`, `theme_by_id`, `themes_as_dict`); see [LANDSCAPE_2026.md](../research/LANDSCAPE_2026.md), [BLUEPRINTS.md](../research/BLUEPRINTS.md). |
...
| [docs/BOOK_COMIC_TECH.md](../guides/BOOK_COMIC_TECH.md) | Sequential-art techniques vs SDX + **best output checklist** (data, training, `generate_book`, pick-best, post). |
...
| [SMOKE_TRAINING.md](../guides/SMOKE_TRAINING.md) | Step-by-step minimal training commands (`--dry-run`, low VRAM tips). |
...
| [docs/IMPROVEMENTS.md](../research/IMPROVEMENTS.md) | Roadmap: quality, fixes, and features from other SD/DiT/FLUX models. |
| [docs/HARDWARE.md](../guides/HARDWARE.md) | PC specs, VRAM, storage for training and full booru scrape. |
| [docs/AR.md](../AR.md) | Block-wise autoregressive (AR): 0 vs 2 vs 4 blocks, raster order, when to use. |
| [docs/TRAINING_TEXT_TO_PIXELS.md](../guides/TRAINING_TEXT_TO_PIXELS.md) | Training mental model: text encoder tokens vs DiT patch tokens; alignment, originality levers. |
...
- **Docs:** [README](../README.md) · [REGION_CAPTIONS](REGION_CAPTIONS.md) · [MODEL_STACK](../MODEL_STACK.md) · [INSPIRATION](../research/INSPIRATION.md) · [IMPROVEMENTS](../research/IMPROVEMENTS.md) · [HARDWARE](../guides/HARDWARE.md)
