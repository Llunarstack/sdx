...
The ViT bridge ([utils/architecture/ar_block_conditioning.py](../utils/architecture/ar_block_conditioning.py)) keys off **`num_ar_blocks`** (0 / 2 / 4 / …). It does **not** encode `ar_block_order` today.
