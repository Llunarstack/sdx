...
3. Use **WebDataset** / large-scale tooling (see [IMPROVEMENTS.md](../research/IMPROVEMENTS.md) §4.1 roadmap) for TB-scale training.

## 7. Memory and disk

- Full Danbooru-scale exports are **terabytes**; always use **`--max-samples`** or shard exports across machines.
- For 16 GB VRAM training tips, see [HARDWARE.md](../guides/HARDWARE.md) and [SMOKE_TRAINING.md](../guides/SMOKE_TRAINING.md).
