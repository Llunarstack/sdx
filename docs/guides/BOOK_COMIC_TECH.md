...
**Next steps (see [IMPROVEMENTS.md](../research/IMPROVEMENTS.md))**
...
- **Regional text:** JSONL **`parts`** / **`region_captions`** → merged captions for T5 ([REGION_CAPTIONS.md](../reference/REGION_CAPTIONS.md)).
...
- Explicit **box + label** conditioning in data (GLIGEN-like) if you extend the DiT cross-attn inputs ([IMPROVEMENTS.md](../research/IMPROVEMENTS.md) §11.4).
...
- **Legible text in-image:** If you need speech bubbles, train with **rendered text** in the image and captions that describe placement (see [REGION_CAPTIONS.md](../reference/REGION_CAPTIONS.md)).
...
- [LANDSCAPE_2026.md](../research/LANDSCAPE_2026.md) — authenticity, multi-stage pipelines
- [IMPROVEMENTS.md](../research/IMPROVEMENTS.md) §11–12
