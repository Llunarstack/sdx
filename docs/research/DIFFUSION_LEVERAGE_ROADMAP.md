...
| **Longer / structured captions** | JSONL `parts`, region captions, layout-aware training data. | `data/t2i_dataset.py`, [REGION_CAPTIONS.md](../reference/REGION_CAPTIONS.md) | Data pipeline |
