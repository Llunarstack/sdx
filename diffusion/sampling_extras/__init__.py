"""
Advanced diffusion **sampling** helpers (CFG shaping, latent refinement, per-step plans).

CLI flags and kwargs still use the ``holy_grail_*`` names for backward compatibility.
"""
